...
# (seed_from, iters, compare_to): run_cdc_scenario seeds the target table
...
# in any order, individually, or in parallel, see run_cdc_scenario's
...
_SCENARIOS = [
    ...
    # iteration — run_cdc_scenario skips it entirely, leaving queen's
