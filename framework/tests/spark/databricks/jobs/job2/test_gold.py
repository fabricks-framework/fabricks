...
from tests.spark.databricks.compare import compare_gold_to_expected
...
def test_gold_scd1_last_timestamp():
    max_timestamp = SPARK.sql("select max(`__valid_from`) as __timestamp from expected.gold_scd2_iter1").collect()[0][0]
