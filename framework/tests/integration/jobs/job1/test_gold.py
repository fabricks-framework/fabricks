...
@pytest.mark.order(129)
def test_job1_gold_fact_order_duplicate():
...
@pytest.mark.order(129)
def test_job1_gold_fact_option():
...
@pytest.mark.order(129)
def test_job1_gold_scd1_last_timestamp():
