...
from tests.integration.helpers.compare import assert_dfs_equal, compare_job_to_expected
...
def test_gold_scd1_complete():
    ...
    compare_job_to_expected(j, "scd1", 11)
...
def test_gold_scd2_complete():
    ...
    compare_job_to_expected(j, "scd2", 11)
...
def test_gold_scd0_update():
    ...
    compare_job_to_expected(j, "scd0", 11)
