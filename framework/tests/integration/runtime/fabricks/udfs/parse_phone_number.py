...
def parse_phone_number(spark: SparkSession):
    def _parse_phone_number(phone_number: str, country: str = "CH"):
        from phonenumbers import PhoneNumberFormat  # pyright: ignore[reportMissingImports]
        from phonenumbers import PhoneNumberMatcher  # pyright: ignore[reportMissingImports]
        from phonenumbers import format_number  # pyright: ignore[reportMissingImports]
