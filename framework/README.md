...
A more advanced config can be found in the [tests](tests/spark/databricks/runtime/fabricks/conf.5589296195699698.yml)
...
- More bronze patterns: `framework/tests/spark/databricks/runtime/bronze/`
...
- Rich silver scenarios (SCD1/2, latest, combine, extenders): `framework/tests/spark/databricks/runtime/silver/`
...
- Advanced gold scenarios (SCD1/2, options, dependencies, invoke): `framework/tests/spark/databricks/runtime/gold/gold/`
