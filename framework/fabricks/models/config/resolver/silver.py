...
class SilverConfigResolver(BaseConfigResolver):
    step: SilverStepConfig
    job: SilverJobConfig

    @classmethod
    def from_file(cls, step: str, topic: str, item: str) -> "SilverConfigResolver":
        ...
        jobs_generator: Generator[SilverJobConfig, None, None] = SilverJobConfig.from_files(jobs_path, root="job")
